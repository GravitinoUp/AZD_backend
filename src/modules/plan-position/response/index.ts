...
export class PlanPositionResponse {
  @ApiProperty()
...
export class ArrayPlanPositionResponse {
  @ApiProperty()
  count: number

  @ApiProperty({ required: false, type: PlanPositionResponse, isArray: true })
  data: PlanPositionResponse[]
}

export class StatusPlanPositionResponse {
  @ApiProperty()
  status: boolean
